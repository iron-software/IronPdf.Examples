...
namespace IronSoftware.IronPdfConsoleFrameworkSamples
{
    public class StampingNewContent : IExecuteApp
    {
        ...
        public void Run()
        {
            ...
            var BackgroundStamp = new HtmlStamp() { Html = "<img src='logo.jpg' />", Width = 50, Height = 25, Opacity = 50, Bottom = 5, ZIndex = HtmlStamp.StampLayer.BehindExistingPDFContent, HtmlBaseUrl = HttpContext.Current.Server.MapPath("~/assets/") };
